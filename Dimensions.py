...
class CalcDimensionsContent(QDMNodeContentWidget):
    ...
    def deserialize(self, data, hashmap={}):
        ...
        try:
            ...
            dumpException(e)
        return res
@register_node(OP_NODE_DIM)
class CalcNode_Dimensions(CalcNode):
    icon = "icons/di.png"
    op_code = OP_NODE_DIM
    op_title = "Dimensions"
    content_label_objname1 = "calc_node_dimlb1"
    content_label_objname2 = "calc_node_dimedit1"
    content_label_objname3 = "calc_node_dimlb2"
    content_label_objname4 = "calc_node_dimedit2"
    GraphicsNode_class = CalcGraphicsNode
    def __init__(self, scene):
        super().__init__(scene, inputs=[], outputs=[4])
        self.eval()
    def initInnerClasses(self):
        self.content = CalcDimensionsContent(self)
